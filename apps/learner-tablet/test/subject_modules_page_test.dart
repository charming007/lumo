...
void main() {
  ...
  testWidgets(
    'home-opened subject page keeps sync-incomplete lesson shells blocked',
    (tester) async {
      SharedPreferences.setMockInitialValues({});
      tester.view.physicalSize = const Size(1400, 1000);
      tester.view.devicePixelRatio = 1.0;
      ...
      await tester.tap(find.text(lessonShell.title));
      await tester.pump(const Duration(milliseconds: 300));

      expect(find.text('Select learner to continue'), findsNothing);
      expect(find.textContaining('Starting ${lessonShell.title}'), findsNothing);
    },
  );
