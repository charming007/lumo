          ...
          <div style={{ display: 'grid', gap: 12 }}>
            ...
            <div style={{ padding: '14px 16px', borderRadius: 18, background: '#EEF2FF', border: '1px solid #C7D2FE' }}>
              ...
              <div style={{ marginTop: 10, color: '#3730A3', lineHeight: 1.6 }}>
                Deployment review gets dangerous when the dashboard implies a different admin scope than the pilot shell actually ships. Keep the route map honest so reviewers validate the real launch path instead of getting dumped into placeholder surfaces.
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
