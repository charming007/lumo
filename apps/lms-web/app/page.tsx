    ...
    <PageShell
      ...
      aside={(
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
          ...
          <Link href="/english" style={{ ...quickActionStyle, background: '#ede9fe', color: '#5b21b6', border: '1px solid #c4b5fd' }}>
            Open English Studio
          </Link>
          ...
          <div style={{ display: 'grid', gap: 12 }}>
            <div style={{ padding: '14px 16px', borderRadius: 18, background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
              ...
              <div style={{ marginTop: 10, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {['Dashboard', 'Content Library', 'English Studio', 'Assignments', 'Progress', 'Settings'].map((label) => (
                  <Pill key={label} label={label} tone="#DCFCE7" text="#166534" />
                ))}
              </div>
              <div style={{ marginTop: 10, color: '#64748b', lineHeight: 1.6 }}>
                This deployment target is intentionally scoped to the six launch-critical LMS surfaces. If a route is not in this list, it should not be treated as part of pilot sign-off just because source files exist elsewhere in the repo.
              </div>
            </div>
            <div style={{ padding: '14px 16px', borderRadius: 18, background: '#EEF2FF', border: '1px solid #C7D2FE' }}>
              ...
              <div style={{ marginTop: 10, color: '#3730A3', lineHeight: 1.6 }}>
                Deployment review gets dangerous when the dashboard implies a different admin scope than the pilot shell actually ships. Keep the route map honest so reviewers validate the real launch path instead of wandering into half-related surfaces.
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              ...
              <Link href="/english" style={{ ...quickActionStyle, background: '#ede9fe', color: '#5b21b6', border: '1px solid #c4b5fd' }}>Open English Studio</Link>
