...
export default async function HomePage() {
  ...
  const topReleaseBlockerBoardHref = topReleaseBlocker
    ? `/content?view=blocked&moduleId=${encodeURIComponent(topReleaseBlocker.id)}${topReleaseBlocker.subjectId.trim()
      ? `&subject=${encodeURIComponent(topReleaseBlocker.subjectId.trim())}`
      : ''}&q=${encodeURIComponent(topReleaseBlocker.title)}`
