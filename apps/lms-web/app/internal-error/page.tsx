...
export default function InternalGlobalErrorPage() {
  return (
    <main
      style={{
        minHeight: '100vh',
    ...
    >
      ...
      >
        ...
        <p style={{ margin: 0, color: '#475569', lineHeight: 1.6 }}>
          This route hit an unrecoverable client/runtime error. Reload once. If it keeps happening, the deployment is not healthy enough to trust.
        </p>
        <div
          style={{
            marginTop: 18,
        ...
        >
          ...
          <span>
            If reload fails, open settings to verify the configured API target, then use the deploy checklist before calling this LMS build healthy.
          </span>
        </div>
