...
const progress: ProgressRecord[] = [
  ...
  { id: 'progress-sadiq-reading', studentId: 'student-sadiq', studentName: 'Sadiq Musa', subjectId: 'subject-literacy', subjectName: 'Foundational Literacy', mastery: 0.48, lessonsCompleted: 3, progressionStatus: 'watch', moduleId: 'module-reading-1', moduleTitle: 'Sound and word recognition', recommendedNextModuleId: 'module-reading-1', recommendedNextModuleTitle: 'Repeat sound recognition practice', lastActiveAt: iso(-3, 15), override: { status: 'watch', reason: 'Held progression after offline oral check showed shaky sound recall.', actorName: 'Aisha Bello', actorRole: 'mallam-lead', updatedAt: iso(-2, 14) } },
