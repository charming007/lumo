    ...
    activitySteps: [
      {
        id: 'lesson-12-step-1',
        type: 'letter_intro',
        prompt: 'This is the letter N. It says /n/.',
        media: [{ kind: 'letter-card', value: 'N' }],
        successFeedback: 'Good. N says /n/.',
      },
      {
        id: 'lesson-12-step-2',
        type: 'image_choice',
      ...
      },
      {
        ...
        prompt: 'Say the sound for N.',
        expectedAnswers: ['/n/', 'n'],
        successFeedback: 'Excellent. Keep that sound clear.',
      },
    ],
  },
  {
    ...
    lessonAssessment: {
      ...
      items: [
        {
          id: 'lesson-13-check-1',
          prompt: 'Build the word c-a-t.',
          promptTranslations: { ha: 'Gina kalmar c-a-t.' },
          skill: 'cvc-build',
          expectedAnswers: ['cat'],
        },
        {
          id: 'lesson-13-check-2',
          prompt: 'Choose the picture for cat.',
          promptTranslations: { ha: 'Zabi hoton kalmar cat.' },
          skill: 'object-word-match',
          choices: ['cat', 'cap', 'bus'],
          correctChoice: 'cat',
        },
    ...
    activitySteps: [
      {
        id: 'lesson-13-step-1',
        type: 'word_build',
        prompt: 'Put the sounds together: c - a - t.',
        media: [{ kind: 'letter-tiles', value: ['c', 'a', 't'] }],
        expectedAnswers: ['cat'],
        successFeedback: 'Yes. c-a-t makes cat.',
      },
      {
        id: 'lesson-13-step-2',
        type: 'image_choice',
        ...
        choices: [
          { id: 'cat', label: 'Cat', media: { kind: 'image', value: 'cat' }, isCorrect: true },
          { id: 'cap', label: 'Cap', media: { kind: 'image', value: 'cap' } },
          { id: 'bus', label: 'Bus', media: { kind: 'image', value: 'bus' } },
        ],
      },
      {
        id: 'lesson-13-step-3',
        ...
        expectedAnswers: ['cat'],
        successFeedback: 'Good reading. You said cat.',
      },
    ],
  },
  {
    ...
    localization: {
      ...
      translations: {
        ...
        ha: {
          title: 'Karanta ka Hada Kalmomin Farko',
        },
      },
    },
    lessonAssessment: {
      ...
      items: [
        {
          id: 'lesson-14-check-1',
          prompt: 'Read the word sun.',
          promptTranslations: { ha: 'Karanta kalmar sun.' },
          skill: 'word-reading',
          expectedAnswers: ['sun'],
        },
        {
          id: 'lesson-14-check-2',
          prompt: 'Tap the picture for sun.',
          promptTranslations: { ha: 'Danna hoton kalmar sun.' },
          skill: 'object-word-match',
          choices: ['sun', 'mat', 'hen'],
          correctChoice: 'sun',
        },
    ...
    activitySteps: [
      {
        id: 'lesson-14-step-1',
        type: 'listen_repeat',
        prompt: 'Read this word: sun.',
        expectedAnswers: ['sun'],
        media: [{ kind: 'word-card', value: 'sun' }],
      },
      {
        id: 'lesson-14-step-2',
        type: 'image_choice',
        prompt: 'Tap the picture for sun.',
        choices: [
          { id: 'sun', label: 'Sun', media: { kind: 'image', value: 'sun' }, isCorrect: true },
          { id: 'mat', label: 'Mat', media: { kind: 'image', value: 'mat' } },
          { id: 'hen', label: 'Hen', media: { kind: 'image', value: 'hen' } },
        ],
      },
    ],
  },
...
const assessments = [
  ...
  },
  {
    ...
    items: [
      {
        id: 'assessment-4-item-1',
        prompt: 'Match the sound /a/ to the correct picture.',
        promptTranslations: { ha: 'Hada sautin /a/ da hoton da ya dace.' },
        skill: 'object-word-match',
        choices: ['apple', 'ball', 'sun'],
        correctChoice: 'apple',
      },
      {
        id: 'assessment-4-item-2',
        prompt: 'Say the sound for N.',
        promptTranslations: { ha: 'Fadi sautin harafin N.' },
        skill: 'phonics',
        expectedAnswers: ['/n/', 'n'],
