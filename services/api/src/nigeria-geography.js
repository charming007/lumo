const NIGERIA_STATE_LGAS = [
  ...
  { name: 'Adamawa', code: 'AD', lgas: ['Demsa', 'Fufore', 'Ganye', 'Gayuk', 'Gombi', 'Grie', 'Hong', 'Jada', 'Lamurde', 'Madagali', 'Maiha', 'Mayo-Belwa', 'Michika', 'Mubi North', 'Mubi South', 'Numan', 'Shelleng', 'Song', 'Toungo', 'Yola North', 'Yola South'] },
  ...
  { name: 'Federal Capital Territory', code: 'FC', type: 'territory', lgas: ['Abaji', 'Abuja Municipal', 'Bwari', 'Gwagwalada', 'Kuje', 'Kwali'] },
];
...
function buildNigeriaGeography() {
  ...
  return { states, localGovernments };
}

const NIGERIA_GEOGRAPHY = buildNigeriaGeography();

module.exports = {
  NIGERIA_STATE_LGAS,
  NIGERIA_GEOGRAPHY,
  buildNigeriaGeography,
  slugify,
};
